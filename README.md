...
```
## Output
<img width="702" height="629" alt="image" src="https://github.com/user-attachments/assets/0c5b0ca1-5a58-44bd-9ed0-a468f32b2a9c" />


## Result
Thus the architecture of a Vehicle-to-Grid is simulated using matlab.
